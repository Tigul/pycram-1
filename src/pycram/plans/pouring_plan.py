...
from src.pycram.designators.location_designator import *
from src.pycram.designators.action_designator import *
from src.pycram.resolver.plans import Arms
from src.pycram.enums import Arms
...
class PouringPlan(object):
    ...
    def __init__(self):
        ...
        # spawn bowl
        self.bowl = Object("bowl", "bowl", "bowl.stl", position=[2.5, 2.8, 0.98])
        self.bowl_desig = ObjectDesignatorDescription(names=["bowl"])
    
        # spawn SM_CokeBottle
        self.SM_CokeBottle = Object("SM_CokeBottle", "SM_CokeBottle", "SM_CokeBottle.stl", position=[2.5, 3, 0.95])
